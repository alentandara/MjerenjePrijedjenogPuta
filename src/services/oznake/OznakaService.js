import OznakaServiceLocalStorage from "./OznakaServiceLocalStorage";
import OznakaServiceMemorija from "./OznakaServiceMemorija";
...
switch (DATA_SOURCE) {
    case 'memorija':
        Servis = OznakaServiceMemorija;
        break;
    case 'localStorage':
        Servis = OznakaServiceLocalStorage;
        break;
    default:
        Servis = null;
}
