import PutServiceLocalStorage from "./PutServiceLocalStorage";
import PutServiceMemorija from "./PutServiceMemorija";
...
switch (DATA_SOURCE) {
    case 'memorija':
        Servis = PutServiceMemorija;
        break;
    case 'localStorage':
        Servis = PutServiceLocalStorage;
        break;
    default:
        Servis = null;
}
